        ...
        <form class="mt-8 space-y-6" @submit.prevent="login">
          ...
          <div class="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input id="email-address" v-model="form.email" type="email" autocomplete="email" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-transparent bg-gray-700 text-white placeholder-gray-500 rounded-t-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Email address">
            </div>
            <div>
